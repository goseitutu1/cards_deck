<div class="aside-menu flex-column-fluid">
						...
						<div class="hover-scroll-overlay-y my-5 my-lg-5" id="kt_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_aside_logo, #kt_aside_footer" data-kt-scroll-wrappers="#kt_aside_menu" data-kt-scroll-offset="0">
							...
							<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_aside_menu" data-kt-menu="true" data-kt-menu-expand="false">
                                <div class="menu-item">
                                    <a class="menu-link" href="{{route('user.dashboard')}}" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right">
                                ...
                                <div class="menu-item">
                                    <a class="menu-link" href="{{route('user.attendance.index')}}" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right">
										<span class="menu-icon">
											<!--begin::Svg Icon | path: icons/duotune/general/gen019.svg-->
											<span class="svg-icon svg-icon-2">
																	<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                ...
                                <div class="menu-item">
                                    <a class="menu-link" href="{{route('user.petty.cash.index')}}" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right">
										<span class="menu-icon">
											<!--begin::Svg Icon | path: icons/duotune/general/gen019.svg-->
											<span class="svg-icon svg-icon-2">
												<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                        ...
                                        <span class="menu-title">Petty Cash Request</span>
                                    </a>
                                </div>

                                <div class="menu-item">
                                    <a class="menu-link" href="{{route('user.transport.request.index')}}" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right">
										<span class="menu-icon">
											<!--begin::Svg Icon | path: icons/duotune/general/gen019.svg-->
											<span class="svg-icon svg-icon-2">
												<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                ...
                                <div class="menu-item">
                                    <a class="menu-link" href="{{route('user.time.sheet.index')}}" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right">
										<span class="menu-icon">
											<!--begin::Svg Icon | path: icons/duotune/general/gen019.svg-->
											<span class="svg-icon svg-icon-2">
												<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                ...
                                <div class="menu-item">
                                    <a class="menu-link" href="{{route('user.excuse.duty.index')}}" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right">
										<span class="menu-icon">
											<!--begin::Svg Icon | path: icons/duotune/general/gen019.svg-->
                                            ...
                                            <!--end::Svg Icon-->
                                        <span class="menu-title">Excuse Duty</span>
                                    </a>
                                </div>

                                @php($user_ = auth()->user())
                            @if($user_->role_id == 3 || $user_->role_id == 1)
                                    <div class="menu-item">
                                        <a class="menu-link" href="{{route('user.visitors.log.book.index')}}" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right">
										<span class="menu-icon">
											<!--begin::Svg Icon | path: icons/duotune/general/gen019.svg-->
											<span class="svg-icon svg-icon-2">
												<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                            ...
                                            <span class="menu-title">Visitors' Logs</span>
                                        </a>
                                    </div>
                                @endif

                                @if($user_->role_id == 1 || $user_->role_id == 2)
                                    <div class="menu-item">
                                        <a class="menu-link" href="{{route('user.asset.index')}}" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right">
										<span class="menu-icon">
											<!--begin::Svg Icon | path: icons/duotune/general/gen019.svg-->
                                            <span class="svg-icon svg-icon-2">
												<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                ...
                                @if($user_->role_id == 1 || $user_->role_id == 2 || $user_->transport_privilege == 'yes' || $user_->role_id == 5)
									...
									<span class="menu-link">
                                        ...
                                        <div class="menu-sub menu-sub-accordion menu-active-bg">
                                            @if($user_->role_id == 1)
                                                <div class="menu-item">
                                                    <a class="menu-link" href="{{route('user.settings.department.index')}}">
                                                ...
                                                <div class="menu-item">
                                                    <a class="menu-link" href="{{route('user.settings.user.profile.index')}}">
												<span class="menu-bullet">
													<span class="bullet bullet-dot"></span>
												</span>
                                                ...
                                                <div class="menu-item">
                                                    <a class="menu-link" href="{{route('user.settings.vehicle.index')}}">
												<span class="menu-bullet">
													<span class="bullet bullet-dot"></span>
												</span>
                                                ...
                                                <div class="menu-item">
                                                    <a class="menu-link" href="{{route('user.settings.pc.categories.index')}}">
												<span class="menu-bullet">
													<span class="bullet bullet-dot"></span>
												</span>
                                                        <span class="menu-title">Petty Cash Categories</span>
                                                    </a>
                                                </div>
                                                <div class="menu-item">
                                                    <a class="menu-link" href="{{route('user.settings.asset.categories.index')}}">
												<span class="menu-bullet">
													<span class="bullet bullet-dot"></span>
												</span>
                                                ...
                                                <div class="menu-item">
                                                    <a class="menu-link" href="{{route('user.event.index')}}">
												<span class="menu-bullet">
													<span class="bullet bullet-dot"></span>
												</span>
                                                ...
                                                <div class="menu-item">
                                                    <a class="menu-link" href="{{route('user.settings.holiday.index')}}">
												<span class="menu-bullet">
													<span class="bullet bullet-dot"></span>
												</span>
                                                ...
                                                <div class="menu-item">
                                                    <a class="menu-link" href="{{route('user.settings.clocking.out.reason.index')}}">
												<span class="menu-bullet">
													<span class="bullet bullet-dot"></span>
												</span>
                                                        <span class="menu-title">Clocking Out Reasons</span>
                                                    </a>
                                                </div>
                                            @elseif($user_->role_id == 5)
                                                <div class="menu-item">
                                                    <a class="menu-link" href="{{route('user.settings.department.index')}}">
												<span class="menu-bullet">
													<span class="bullet bullet-dot"></span>
                                            ...
                                            @elseif($user_->transport_privilege == 'yes')
                                                <div class="menu-item">
                                                    <a class="menu-link" href="{{route('user.settings.vehicle.index')}}">
												<span class="menu-bullet">
													<span class="bullet bullet-dot"></span>
                                ...
                                @if($user_->role_id == 5)
									...
									<span class="menu-link">
										...
										<span class="menu-title">Administrative Tool</span>
										<span class="menu-arrow"></span>
									</span>
                                        <div class="menu-sub menu-sub-accordion menu-active-bg">
                                            <div class="menu-item">
                                                <a class="menu-link" href="{{route('user.administrative.tool.attendance.index')}}">
												<span class="menu-bullet">
													<span class="bullet bullet-dot"></span>
												</span>
                                                    <span class="menu-title">Attendance</span>
                                ...
                                @if($user_->role_id == 1 || $user_->role_id == 2 || $user_->transport_privilege == 'yes' || $user_->role_id == 5)
									...
									<span class="menu-link">
                                        ...
                                        @if($user_->role_id == 1)
                                                <div class="menu-item">
                                                    <a class="menu-link" href="{{route('user.petty.cash.report')}}">
												<span class="menu-bullet">
													<span class="bullet bullet-dot"></span>
												</span>
                                                ...
                                                <div class="menu-item">
                                                    <a class="menu-link" href="{{route('user.petty.cash.category.report')}}">
												<span class="menu-bullet">
													<span class="bullet bullet-dot"></span>
												</span>
                                                        <span class="menu-title">Petty Cash Category</span>
                                                    </a>
                                                </div>
                                                <div class="menu-item">
                                                    <a class="menu-link" href="{{route('user.transport.request.report')}}">
												<span class="menu-bullet">
													<span class="bullet bullet-dot"></span>
												</span>
                                                        <span class="menu-title">Transport Request</span>
                                                ...
                                                <div class="menu-item">
                                                    <a class="menu-link" href="{{route('user.attendance.report')}}">
												<span class="menu-bullet">
													<span class="bullet bullet-dot"></span>
												</span>
                                                        <span class="menu-title">Attendance</span>
                                                ...
                                                <div class="menu-item">
                                                    <a class="menu-link" href="{{route('user.excuse.duty.report')}}">
												<span class="menu-bullet">
													<span class="bullet bullet-dot"></span>
												</span>
                                                        <span class="menu-title">Excuse Duty</span>
                                                ...
                                                <div class="menu-item">
                                                    <a class="menu-link" href="{{route('user.time.sheet.report')}}">
												<span class="menu-bullet">
													<span class="bullet bullet-dot"></span>
												</span>
                                                        <span class="menu-title">Time Sheet</span>
...
{{--                                                if login user is HR--}}
                                            @elseif($user_->role_id == 5)
                                                ...
                                                {{--                                                if login user is finance manager or has transport privileges--}}
                                            @elseif($user_->transport_privilege == 'yes' && $user_->role_id == 2)
                                                <div class="menu-item">
                                                    <a class="menu-link" href="{{route('user.transport.request.report')}}">
												<span class="menu-bullet">
													<span class="bullet bullet-dot"></span>
                                                ...
                                                {{--                                                if login user has transport privileges--}}
                                            @elseif($user_->transport_privilege == 'yes')
                                                <div class="menu-item">
                                                    <a class="menu-link" href="{{route('user.transport.request.report')}}">
												<span class="menu-bullet">
                                                ...
                                                {{--                                                if login user is finance manager--}}
